...
class Footer extends Component {
    subscribeIt(event) {
        ...
        document
            .querySelector('.subscribe__wrapper')
            .appendChild(
                document.createTextNode('Подписка оформлена! Спасибо!')
            );
    }
            ...
            <footer className="footer">
                <section className="subscribe">
                    <div className="subscribe__wrapper">
                        ...
                        <form
                            className="subscribe__radios"
                            action=""
                            onSubmit={this.subscribeIt}
                        >
                            <label className="subscribe__radio_label">
                                <input
                                    ...
                                    value="women"
                                />
                                <div className="subscribe__radio_text">
                                    Женское
                                </div>
                            </label>
                            <label className="subscribe__radio_label">
                ...
                <div className="footer__bottom">
                    <div className="wrapper">
                        <div className="footer__menus">
                            <div className="footer__menu footer__menu_about">
                                О магазине
                                <ul>
                                    <li>
                                        <a>BosaNoga</a>
                            ...
                            <div className="footer__menu footer__menu_collection">
                                Коллекции
                                <ul>
                                    <li>
                                        <a>Обувь</a>
                            ...
                            <div className="footer__menu footer__menu_help">
                                Помощь
                                <ul>
                                    <li>
                                        <a>Как купить?</a>
                        ...
                        <div className="footer__info">
                            <h3 className="footer__info_title">
                                Принимаем к оплате:
                            </h3>
                            ...
                            <div className="footer__social-links">
                                <h3 className="footer__social-links_title">
                                    Мы в соц.сетях:
                                </h3>
                            ...
                            <div className="footer__copyright">
                                2009-2018 © BosaNoga.ru — модный
                                интернет-магазин обуви
                                <br /> и аксессуаров. Все права защищены.
                        ...
                        <div className="footer__contacts">
                            ...
                            <p className="footer__phone_text">
